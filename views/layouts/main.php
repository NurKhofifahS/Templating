...
<link href="<?= Yii::getAlias('@web') ?>/css/bootstrap.min.css" rel="stylesheet" media="screen">
<link href="<?= Yii::getAlias('@web') ?>/css/style.css" rel="stylesheet" media="screen">
    ...
    <div class="container">
      ...
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          <class="current"><a href="#intro">Home</a>
